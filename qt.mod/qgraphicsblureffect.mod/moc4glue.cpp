...
const QMetaObject MaxQGraphicsBlurEffect::staticMetaObject = {
    { &QGraphicsBlurEffect::staticMetaObject, qt_meta_stringdata_MaxQGraphicsBlurEffect,
      qt_meta_data_MaxQGraphicsBlurEffect, 0 }
};
...
int MaxQGraphicsBlurEffect::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: onBlurHintsChanged((*reinterpret_cast< BlurHints(*)>(_a[1]))); break;
        case 1: onBlurRadiusChanged((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 2: onEnabledChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
