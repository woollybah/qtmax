...
void MaxQDialogButtonBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        MaxQDialogButtonBox *_t = static_cast<MaxQDialogButtonBox *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData MaxQDialogButtonBox::staticMetaObjectExtraData = {
...
const QMetaObject MaxQDialogButtonBox::staticMetaObject = {
    { &QDialogButtonBox::staticMetaObject, qt_meta_stringdata_MaxQDialogButtonBox,
      qt_meta_data_MaxQDialogButtonBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MaxQDialogButtonBox::getStaticMetaObject() { return staticMetaObject; }
