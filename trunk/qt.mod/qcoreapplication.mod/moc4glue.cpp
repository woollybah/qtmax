...
void MaxQCoreApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        MaxQCoreApplication *_t = static_cast<MaxQCoreApplication *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData MaxQCoreApplication::staticMetaObjectExtraData = {
...
const QMetaObject MaxQCoreApplication::staticMetaObject = {
    { &QCoreApplication::staticMetaObject, qt_meta_stringdata_MaxQCoreApplication,
      qt_meta_data_MaxQCoreApplication, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MaxQCoreApplication::getStaticMetaObject() { return staticMetaObject; }
