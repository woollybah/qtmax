...
void MaxQMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        MaxQMenu *_t = static_cast<MaxQMenu *>(_o);
        switch (_id) {
        case 0: _t->onAboutToHide(); break;
        case 1: _t->onAboutToShow(); break;
        case 2: _t->onHovered((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 3: _t->onTriggered((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
